    ...
    var template = {
       //获取详情数据
        ...
        readAd: function (isAD, data, adIndex) {
            ...
            adlist=shuffle(adlist).slice(0,7);
        ...
        styleDetail: function (data) {
            ...
            return '  <li class="n-item will-active news-item splitter container single-pic-item"><a' +
                ...
                '                <div class="n-desc"><span class="info element"><span>'+(data.source=="undefined"?"":data.source)+'</span><span class="n-ptime"></span></span>' +
                '                </div>' +
                '            </a></li>';
        },
